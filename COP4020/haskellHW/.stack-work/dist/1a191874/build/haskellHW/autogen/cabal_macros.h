...
/* package haskellHW-0.1.0.0 */
#ifndef VERSION_haskellHW
#define VERSION_haskellHW "0.1.0.0"
#endif /* VERSION_haskellHW */
#ifndef MIN_VERSION_haskellHW
#define MIN_VERSION_haskellHW(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellHW */
...
#define CURRENT_COMPONENT_ID "haskellHW-0.1.0.0-GhEfIyyXcaW2SMHARG0lvz-haskellHW"
